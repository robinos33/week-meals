...
const UNITS: &[(&str, Unit, f64)] = &[
    ...
    ("paquets", Unit::Paquet, 1.0),
    ("paquet", Unit::Paquet, 1.0),
    ("boîtes", Unit::Boite, 1.0),
    ("boîte", Unit::Boite, 1.0),
    ("sachets", Unit::Sachet, 1.0),
    ("sachet", Unit::Sachet, 1.0),
    ("bouteilles", Unit::Bouteille, 1.0),
    ("bouteille", Unit::Bouteille, 1.0),
    ("pots", Unit::Pot, 1.0),
    ("pot", Unit::Pot, 1.0),
    ("bottes", Unit::Botte, 1.0),
    ("botte", Unit::Botte, 1.0),
    ("barquettes", Unit::Barquette, 1.0),
    ("barquette", Unit::Barquette, 1.0),
    ("tranches", Unit::Tranche, 1.0),
    ("tranche", Unit::Tranche, 1.0),
    ("kg", Unit::Kg, 1.0),
    ("mg", Unit::G, 0.001),
    ("ml", Unit::Ml, 1.0),
    ("cl", Unit::Ml, 10.0),
