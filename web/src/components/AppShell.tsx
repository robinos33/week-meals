 ...
 * en tenant compte des zones sûres (encoches) du plein écran PWA. La barre est
 * masquée sur l'écran de connexion (plein écran).
 */
export function AppShell() {
  ...
  return (
    <div className="app-shell" data-chromeless={chromeless}>
      {!chromeless && (
